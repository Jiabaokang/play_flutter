...
class StringStyles {
  ...
  static const String actionConfirm = "actionConfirm";
  static const String actionCancel = "actionCancel";
  static const String viewStateMessageError = "viewStateMessageError";
  static const String viewStateMessageNetworkError =
      "viewStateMessageNetworkError";
  static const String viewStateMessageEmpty = "viewStateMessageEmpty";
  static const String viewStateMessageUnAuth = "viewStateMessageUnAuth";
  static const String viewStateButtonRefresh = "viewStateButtonRefresh";
  static const String viewStateButtonRetry = "viewStateButtonRetry";
  static const String viewStateButtonLogin = "viewStateButtonLogin";
  static const String refreshTwoLevel = "refreshTwoLevel";
  static const String splashSkip = "splashSkip";
  static const String tabProject = "tabProject";
  static const String tabStructure = "tabStructure";
  static const String tabUser = "tabUser";
  static const String setting = "setting";
  static const String settingFont = "settingFont";
  ...
  static const String githubIssue = "githubIssue";
  static const String autoBySystem = "autoBySystem";
  static const String fontKuaiLe = "fontKuaiLe";
  static const String fieldNotNull = "fieldNotNull";
  static const String userName = "userName";
  static const String password = "password";
  static const String toSignUp = "toSignUp";
  static const String signUp = "signUp";
  static const String rePassword = "rePassword";
  static const String twoPwdDifferent = "twoPwdDifferent";
  static const String toSignIn = "toSignIn";
  static const String signIn = "signIn";
  static const String noAccount = "noAccount";
  static const String myFavourites = "myFavourites";
  static const String signIn3thd = "signIn3thd";
  static const String searchHot = "searchHot";
  static const String searchShake = "searchShake";
  static const String clear = "clear";
  static const String refresh = "refresh";
  static const String unLike = "unLike";
  static const String share = "share";
  static const String wechatAccount = "wechatAccount";
  static const String rate = "rate";
  static const String needLogin = "needLogin";
  static const String loadFailed = "loadFailed";
  static const String collectionRemove = "collectionRemove";
  static const String articleTagTop = "article_tag_top";
  static const String openBrowser = "openBrowser";
  static const String appUpdateCheckUpdate = "appUpdateCheckUpdate";
  static const String appUpdateActionUpdate = "appUpdateActionUpdate";
  static const String appUpdateLeastVersion = "appUpdateLeastVersion";
  static const String appUpdateDownloading = "appUpdateDownloading";
  static const String appUpdateDownloadFailed = "appUpdateDownloadFailed";
  static const String appUpdateReDownloadContent = "appUpdateReDownloadContent";
  static const String appUpdateActionDownloadAgain =
      "appUpdateActionDownloadAgain";
  static const String appUpdateActionInstallApk = "appUpdateActionInstallApk";
  static const String appUpdateUpdate = "appUpdateUpdate";
  static const String appUpdateFoundNewVersion = "appUpdateFoundNewVersion";
  static const String appUpdateDownloadCanceled = "appUpdateDownloadCanceled";
  static const String appUpdateDoubleBackTips = "appUpdateDoubleBackTips";
}
...
class Messages extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
    'zh_CN': {
      ...
      StringStyles.actionConfirm: "确认",
      StringStyles.actionCancel: "取消",
      StringStyles.viewStateMessageError: "加载失败",
      StringStyles.viewStateMessageNetworkError: "网络连接异常,请检查网络或稍后重试",
      StringStyles.viewStateMessageEmpty: "空空如也",
      StringStyles.viewStateMessageUnAuth: "未登录",
      StringStyles.viewStateButtonRefresh: "刷新一下",
      StringStyles.viewStateButtonRetry: "重试",
      StringStyles.viewStateButtonLogin: "登录",
      StringStyles.refreshTwoLevel: "欢迎光临,我的空中楼阁",
      StringStyles.splashSkip: "跳过",
      StringStyles.tabProject: "项目",
      StringStyles.tabStructure: "体系",
      StringStyles.tabUser: "我的",
      StringStyles.setting: "设置",
      StringStyles.settingFont: "字体",
      StringStyles.logout: "退出登录",
      StringStyles.darkMode: "黑夜模式",
      StringStyles.theme: "色彩主题",
      StringStyles.about: "关于",
      StringStyles.close: "关闭",
      StringStyles.feedback: "意见反馈",
      StringStyles.githubIssue: "未找到邮件客户端,请前往github,提issue",
      StringStyles.autoBySystem: "跟随系统",
      StringStyles.fontKuaiLe: "快乐字体",
      StringStyles.fieldNotNull: "不能为空",
      StringStyles.userName: "用户名",
      StringStyles.password: "密码",
      StringStyles.signUp: "注册",
      StringStyles.toSignUp: "去注册",
      StringStyles.rePassword: "确认密码",
      StringStyles.twoPwdDifferent: "两次密码不一致",
      StringStyles.toSignIn: "点我登录",
      StringStyles.signIn: "登录",
      StringStyles.noAccount: "还没账号? ",
      StringStyles.myFavourites: "我的收藏",
      StringStyles.signIn3thd: "第三方登录",
      StringStyles.searchHot: "热门搜索",
      StringStyles.searchShake: "换一换",
      StringStyles.clear: "清空",
      StringStyles.refresh: "刷新",
      StringStyles.unLike: "取消收藏",
      StringStyles.share: "分享",
      StringStyles.wechatAccount: "公众号",
      StringStyles.rate: "评分",
      StringStyles.needLogin: "请先登录",
      StringStyles.loadFailed: "加载失败,请稍后重试",
      StringStyles.collectionRemove: "移除收藏",
      StringStyles.articleTagTop: "置顶",
      StringStyles.openBrowser: "浏览器打开",
      StringStyles.appUpdateCheckUpdate: "检查更新",
      StringStyles.appUpdateActionUpdate: "更新",
      StringStyles.appUpdateLeastVersion: "已是最新版本",
      StringStyles.appUpdateDownloading: "下载中,请稍后...",
      StringStyles.appUpdateDownloadFailed: "下载失败",
      StringStyles.appUpdateReDownloadContent: "检测到本地已下载过该版本,是否直接安装?",
      StringStyles.appUpdateActionDownloadAgain: "重新下载",
      StringStyles.appUpdateActionInstallApk: "直接安装",
      StringStyles.appUpdateUpdate: "版本更新",
      StringStyles.appUpdateFoundNewVersion: "发现新版本{version},是否更新?",
      StringStyles.appUpdateDownloadCanceled: "下载已取消",
      StringStyles.appUpdateDoubleBackTips: "再次点击返回键,取消下载"
    },
    'zh_HK': {
    ...
    'en_US': {
      ...
      StringStyles.actionConfirm: "Confirm",
      StringStyles.actionCancel: "Cancel",
      StringStyles.viewStateMessageError: "Load Failed",
      StringStyles.viewStateMessageNetworkError:
      "Load Failed,Check network ",
      StringStyles.viewStateMessageEmpty: "Nothing Found",
      StringStyles.viewStateMessageUnAuth: "Not sign in yet",
      StringStyles.viewStateButtonRefresh: "Refresh",
      StringStyles.viewStateButtonRetry: "Retry",
      StringStyles.viewStateButtonLogin: "Sign In",
      StringStyles.refreshTwoLevel: "release to enter second floor",
      StringStyles.splashSkip: "Skip",
      StringStyles.tabProject: "Project",
      StringStyles.tabStructure: "Structure",
      StringStyles.tabUser: "Me",
      StringStyles.setting: "Setting",
      StringStyles.settingFont: "System Font",
      StringStyles.logout: "Sign Out",
      StringStyles.darkMode: "Dark Mode",
      StringStyles.theme: "Theme",
      StringStyles.about: "About",
      StringStyles.close: "Close",
      StringStyles.feedback: "FeedBack",
      StringStyles.githubIssue: "Can't find mail app,please github issues",
      StringStyles.autoBySystem: "Auto",
      StringStyles.fontKuaiLe: "ZCOOL KuaiLe",
      StringStyles.fieldNotNull: "not empty",
      StringStyles.userName: "Username",
      StringStyles.password: "Password",
      StringStyles.toSignUp: "Sign Up",
      StringStyles.signUp: "Sign Up",
      StringStyles.rePassword: "Confirm Password",
      StringStyles.twoPwdDifferent: "The two passwords differ",
      StringStyles.toSignIn: "Sign In",
      StringStyles.signIn: "Sign In",
      StringStyles.noAccount: "No Account ? ",
      StringStyles.myFavourites: "My favourites",
      StringStyles.signIn3thd: "More",
      StringStyles.searchHot: "Hot",
      StringStyles.searchShake: "Shake",
      StringStyles.clear: "Clear",
      StringStyles.refresh: "Refresh",
      StringStyles.unLike: "UnLike",
      StringStyles.share: "Share",
      StringStyles.wechatAccount: "Wechat",
      StringStyles.rate: "Rate",
      StringStyles.needLogin: "Go to Sign In",
      StringStyles.loadFailed: "Load failed,retry later",
      StringStyles.collectionRemove: "Remove",
      StringStyles.articleTagTop: "Top",
      StringStyles.openBrowser: "Open Browser",
      StringStyles.appUpdateCheckUpdate: "Check Update",
      StringStyles.appUpdateActionUpdate: "Update",
      StringStyles.appUpdateLeastVersion: "Least version now ",
      StringStyles.appUpdateDownloading: "Downloading...",
      StringStyles.appUpdateDownloadFailed: "Download failed",
      StringStyles.appUpdateReDownloadContent:
      "It has been detected that it has been downloaded, whether it is installed?",
      StringStyles.appUpdateActionDownloadAgain: "Download",
      StringStyles.appUpdateActionInstallApk: "Install",
      StringStyles.appUpdateUpdate: "Version Update",
      StringStyles.appUpdateFoundNewVersion: "New version {version}",
      StringStyles.appUpdateDownloadCanceled: "Download canceled",
      StringStyles.appUpdateDoubleBackTips:
